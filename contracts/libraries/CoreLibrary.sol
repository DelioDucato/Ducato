...
library CoreLibrary {
    ...
    struct ReserveData {
        ...
        **/
        ...
        uint256 decimals;
        /**
        * @dev address of the kToken representing the asset
        **/
        ...
        **/
        ...
        bool isActive;
        // isFreezed = true means the reserve only allows repays and redeems, but not deposits, new borrowings 
        bool isFreezed;
    }
    ...
    * @param _reserve the reserve object
    ...
    /**
    * @dev Updates the liquidity cumulative index Ci and variable borrow cumulative index Bvc. 
    ...
    * @param _self the reserve object
    * @param _kTokenAddress the address of the overlying atoken contract
    * @param _decimals the number of decimals of the underlying asset
    * @param _interestRateStrategyAddress the address of the interest rate strategy contract
    **/
    function init(
        ReserveData storage _self,
        address _kTokenAddress,
        uint256 _decimals,
        address _interestRateStrategyAddress
    ) external {
        require(_self.kTokenAddress == address(0), "Reserve has already been initialized");
        ...
        _self.kTokenAddress = _kTokenAddress;
